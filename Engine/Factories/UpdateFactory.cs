...
namespace Engine.Factories
{
    internal class UpdateFactory
    {
        internal Updates CreateUpdate()
        {
            ...
            newUpdate.AddDailyUpdate("New York City", 27, "New York has had 150,000 cases. Globally, there have been more than 1.5 million cases and 80,000 deaths.", "/Engine;component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("New York City", 28, "4/9", "/Engine;component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("New York City", 29, "4/10", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("New York City", 30, "4/11", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("New York City", 31, "4/12", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("New York City", 32, "4/13", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("New York City", 33, "4/14", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("New York City", 34, "4/15", "/Engine;component/Images/Map/map_18.png");
            newUpdate.AddDailyUpdate("New York City", 35, "4/16", "/Engine;component/Images/Map/map_19.png");
            newUpdate.AddDailyUpdate("New York City", 36, "4/17", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("New York City", 37, "4/18", "/Engine;component/Images/Map/map_20.png");
            ...
            newUpdate.AddDailyUpdate("London", 31, "British officals have requested ventilators from the White House. President Trump said that he will help them as they have been good partners.", "/Engine;component/Images/Map/map_14.png");
            newUpdate.AddDailyUpdate("London", 32, "Globally, there have been more than 1.5 million cases and 80,000 deaths. The EU plans to prolong the non-essential travel ban until May 15.", "/Engine;component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("London", 33, "4/9", "/Engine; component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("London", 34, "4/10", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("London", 35, "4/11", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("London", 36, "4/12", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("London", 37, "4/13", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("London", 38, "4/14", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("London", 39, "4/15", "/Engine;component/Images/Map/map_18.png");
            newUpdate.AddDailyUpdate("London", 40, "4/16", "/Engine;component/Images/Map/map_19.png");
            newUpdate.AddDailyUpdate("London", 41, "4/17", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("London", 42, "4/18", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("London", 43, "4/19", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("London", 44, "4/20", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("London", 45, "4/21", "/Engine;component/Images/Map/map_20.png");
            ...
            newUpdate.AddDailyUpdate("LosAngeles", 1, "Los Angeles has had 20 cases and its first death.", "/Engine;component/Images/Map/map_08.png");
            newUpdate.AddDailyUpdate("LosAngeles", 2, "Former President Barack Obama has requested online that people look out for one another.", "/Engine;component/Images/Map/map_08.png");
            newUpdate.AddDailyUpdate("LosAngeles", 3, "President Trump has declared a national emergency.", "/Engine;component/Images/Map/map_08.png");
            newUpdate.AddDailyUpdate("LosAngeles", 4, "The United States has surpassed 50 deaths. President Trump has tested negative.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 5, "Los Angeles has had 50 cases. Italy has surpassed 1,800 deaths. The C.D.C. advised no gatherings of 50 or more people.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 6, "The LA County has closed bars, gyms, movie theaters, and schools. Italy has surpassed 25,000 cases.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 7, "Los Angeles has had 100 cases. Courts have closed.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 8, "Los Angeles has had 200 cases. The U.S. has closed its borders to non-esssential traveling. President Trump has signed into a COVID-19 relief package which includes free testing and paid emergency leave.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 9, "China has reported no COVID-19 cases for the first time since the pandemic began. Italy now has the most COVID-19 related deaths at 3,405.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 10, "Spain has nearly 20,000 cases.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 11, "Los Angeles has had 300 cases. Italy has surpassed 50,000 cases.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 12, "Los Angeles has had 400 cases and 5 deaths. New York City has surpased 10,000 cases. Senator Rand Paul has become the first senator to test positive.", "/Engine;component/Images/Map/map_09.png");
            newUpdate.AddDailyUpdate("LosAngeles", 13, "Los Angeles has had 500 cases. Iran has surpassed 20,000 cases. Globally, there have been more than 300,000 cases.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 14, "Los Angeles has had 600 cases and 10 deaths. The United States has surpassed 50,000 cases. Chinese authorities have stated that travel restrictions in Wuahn will be lifted on 4/8.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 15, "Los Angeles has had 800 cases. The White House and Senate have agreed upon a $2 trillion stimulus deal to help lessen the economic damage of COVID-19. Spain now has the second-highest death toll at 3,434.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 16, "Los Angeles has had 1,000 cases and 20 deaths. California has surpassed 3,000 cases. Gun stores have been closed in 42 cities.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 17, "The United States have surpassed Italy and China with most confirmed cases at more than 86,000. Globally, there have been more than 500,000 cases.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 18, "Italy has surpassed 10,000 deaths. South Korea has reported more recoveries than active COVID-19 cases for the first time since the start of the outbreak.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 19, "Los Angeles has had 2,000 cases.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 20, "Farmer’s markets have closed. The Tokyo 2020 Olympic Games have been postponed to 2021.", "/Engine;component/Images/Map/map_10.png");
            newUpdate.AddDailyUpdate("LosAngeles", 21, "Los Angeles has had 3,000 cases and 50 deaths.", "/Engine;component/Images/Map/map_11.png");
            newUpdate.AddDailyUpdate("LosAngeles", 22, "A 6-week-old baby, the youngest victim to date, has died due to COVID-19.", "/Engine;component/Images/Map/map_11.png");
            newUpdate.AddDailyUpdate("LosAngeles", 23, "Globally, there have been more than 1 million cases. Spain has surpassed 10,000 deaths.", "/Engine;component/Images/Map/map_11.png");
            newUpdate.AddDailyUpdate("LosAngeles", 24, "The Trump Administration is recommending that Americans wear non-medical cloth face coverings.", "/Engine;component/Images/Map/map_12.png");
            newUpdate.AddDailyUpdate("LosAngeles", 25, "Los Angeles has had 100 deaths. New York has had 100 deaths.", "/Engine;component/Images/Map/map_13.png");
            newUpdate.AddDailyUpdate("LosAngeles", 26, "President Trump stated that he believes everything will be alright in the end in a press briefing.", "/Engine;component/Images/Map/map_13.png");
            newUpdate.AddDailyUpdate("LosAngeles", 27, "All Los Angeles County residents are eligible for COVID-19 testing.", "/Engine;component/Images/Map/map_14.png");
            newUpdate.AddDailyUpdate("LosAngeles", 28, "42 states have issued stay at home orders. President Trump stated that there will be 110,000 ventilators issued to states by June.", "/Engine;component/Images/Map/map_14.png");
            newUpdate.AddDailyUpdate("LosAngeles", 29, "Los Angeles has had 7,000 cases.", "/Engine;component/Images/Map/map_14.png");
            newUpdate.AddDailyUpdate("LosAngeles", 30, "Globally, there have been more than 1.5 million cases and 80,000 deaths. California has a $1.4 billion plan to buy medical equipment.", "/Engine;component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("LosAngeles", 31, "4/9", "/Engine;component/Images/Map/map_15.png");
            newUpdate.AddDailyUpdate("LosAngeles", 31, "4/10", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("LosAngeles", 32, "4/11", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("LosAngeles", 33, "4/12", "/Engine;component/Images/Map/map_16.png");
            newUpdate.AddDailyUpdate("LosAngeles", 34, "4/13", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("LosAngeles", 35, "4/14", "/Engine;component/Images/Map/map_17.png");
            newUpdate.AddDailyUpdate("LosAngeles", 36, "4/15", "/Engine;component/Images/Map/map_18.png");
            newUpdate.AddDailyUpdate("LosAngeles", 37, "4/16", "/Engine;component/Images/Map/map_19.png");
            newUpdate.AddDailyUpdate("LosAngeles", 38, "4/17", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("LosAngeles", 39, "4/18", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("LosAngeles", 40, "4/19", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("LosAngeles", 41, "4/20", "/Engine;component/Images/Map/map_20.png");
            newUpdate.AddDailyUpdate("LosAngeles", 42, "4/21", "/Engine;component/Images/Map/map_20.png");
